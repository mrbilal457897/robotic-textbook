  ...
  return (
    <>
      ...
      >
                ...
                <>
                  {searchResults.map((result, index) => (
                    <Link
                      key={result.id}
                      to={result.url}
                      className={`${styles.mobileSearchResultItem} ${index === selectedIndex ? styles.mobileSearchResultActive : ''}`}
                      onClick={() => {
                        setSearchQuery('');
                        setIsMobileMenuOpen(false);
                      }}
        ...
        {/* Mobile Utilities: Language Selector, Theme Toggle & GitHub (Icons Only) */}
